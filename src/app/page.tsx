          ...
          <div className="space-y-8">
            ...
            >
              ...
              <p className="text-blue-100 leading-relaxed">
                I developed comprehensive benchmarking pipelines for agentic AI systems, creating sophisticated harnesses in Python and Firebase to stress-test over 20 tools for latency, scalability, and fault tolerance. This work reduced manual validation effort by 25%. Working closely with Google Cloud Product Managers, I engineered a real-time monitoring system that aggregates data across 50+ projects to track over 10,000 resources. Through optimized queries, I cut infrastructure waste by 18% and significantly improved visibility. I also implemented high-throughput REST APIs and backend modules using Python and Firebase Cloud Functions, processing over 10,000 weekly requests with response times optimized to sub-200ms, all while maintaining 90% unit test coverage and robust CI/CD pipelines.
              </p>
            </motion.div>
